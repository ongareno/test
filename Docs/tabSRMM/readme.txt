				tabbed  SRMM plugin for Miranda IM 0.7.0.0
				------------------------------------------

NOTE: This is OUTDATED and needs to be adjusted to the current state of the
      code. For more information, check the online resources.
